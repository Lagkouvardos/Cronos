...
write.table(x = testLOO,  file = paste(working_directory,paste(dir_with_files,'Test Sets LOO.csv',     sep = '/'),sep = '' ), col.names = T)
write.table(x = trainStr, file = paste(working_directory,paste(dir_with_files,'Training Sets Splitted.csv', sep = '/'),sep='' ), col.names = T)
write.table(x = testStr,  file = paste(working_directory,paste(dir_with_files,'Test Sets Splitted.csv', sep = '/'),sep = '') , col.names = T)
