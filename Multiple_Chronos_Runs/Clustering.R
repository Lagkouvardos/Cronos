...
setwd("~/Working_Chronos/Multiple_Chronos_Runs/")              #<--- CHANGE ACCORDINGLY !!!
...
meta_file <- read.table (file = input_meta, check.names = FALSE, header = TRUE, sep = ",", row.names = 1, comment.char = "", stringsAsFactors = F)
